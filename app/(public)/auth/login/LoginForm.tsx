...
import { TrendingUp, Mail, Lock, ArrowRight, Eye, EyeOff, AlertCircle } from "lucide-react";
...
export default function LoginForm() {
   ...
   // Show loading only while checking initial session
   if (status === "loading") {
      return (
         ...
         <div className="flex items-center justify-center px-4 sm:px-6 lg:px-8 py-12 min-h-[calc(100vh-4rem)]">
            <div className="w-full max-w-md">
               <div className="text-center mb-8">
                  ...
                  <p className="text-gray-400">Log in to access your portfolio</p>
               </div>
               ...
               <div className="bg-[#212224] rounded-xl border border-[#33313c] p-8 shadow-2xl">
                     ...
                     <div className="flex items-center justify-between">
                        <div className="flex items-center">
                           <input
                              ...
                              className="h-4 w-4 bg-[#161616] border-[#33313c] rounded text-[#facc15] focus:ring-[#facc15] focus:ring-offset-0"
                           />
                           <label
                              htmlFor="remember-me"
                        ...
                        <Link
                           ...
                           className="text-sm text-[#facc15] hover:text-[#fcd34d] transition-colors"
                        >
                           Forgot password?
                        </Link>
                     </div>
                  ...
                  <div className="relative my-6">
                     ...
                     <div className="relative flex justify-center text-sm">
                        <span className="px-2 bg-[#212224] text-gray-500">Or continue with</span>
                     </div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                     <button
                        ...
                        disabled={isLoading}
                        className="flex items-center justify-center gap-2 px-4 py-3 bg-[#161616] border border-[#33313c] rounded-lg hover:border-[#facc15] transition-all hover:scale-105 disabled:opacity-50"
                     >
