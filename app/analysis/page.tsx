...
import { processEfficiencyAndLeverage } from './processEfficiencyAndLeverage';
import { processLiquidity } from './processLiquidity';
import { processProfitability } from './processProfitability';
import { processValuation } from './processValuation';
    ...
    async function handleData(){
        try {
            ...
            if (!company){
                ...
                const companyData = {
                    name: select, 
                    profitability:{annual:data1.annualResult, quarterly:data1.quarterlyResult}, efficiencyAndLeverage:{debtToEquityAnnual:data2.annualResult1, debtToEquityQuarterly:data2.quarterlyResult1, ebitdaAnnual:data2.annualResult2, ebitdaQuarterly:data2.quarterlyResult2}, 
                    liquidity:{cashFlowAnnual:data3.annualResult1, cashFlowQuarterly:data3.quarterlyResult1, currentRatioAnnual:data3.annualResult2, currentRatioQuarterly:data3.quarterlyResult2}, valuation:{epsAnnual:data4.annualResult1, epsQuarterly:data4.quarterlyResult1, peRatioAnnual:data4.annualResult2, peRatioQuarterly:data4.quarterlyResult2}
                };
